...
public class Memcached {
    ...
    public Future<Boolean> delete(String key) {
        if(log.isDebugEnabled())
            log.debug("Excluindo " + key + "...");
        return memcached.delete(key);
    }

    public <T> Future<T> get(String key) {
        if(log.isDebugEnabled())
            log.debug("Obtendo " + key + "...");
    ...
    public Future<Boolean> set(String key, int ttl, Object o) {
        if(log.isDebugEnabled())
            log.debug("Setando [" + key + ", ttl:" + ttl + "]: " + ToStringBuilder.reflectionToString(o) + "...");
    ...
    public Future<Boolean> add(String key, int ttl, Object o) {
        if(log.isDebugEnabled())
            log.debug("Adicionando [" + key + ", ttl:" + ttl + "]: " + ToStringBuilder.reflectionToString(o) + "...");
    ...
    public Future<Boolean> replace(String key, int ttl, Object o) {
        if(log.isDebugEnabled())
            log.debug("Substituindo [" + key + ", ttl:" + ttl + "]: " + ToStringBuilder.reflectionToString(o) + "...");
